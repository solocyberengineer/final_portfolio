<template>
    <div class="loaderContainer container-fluid vh-100 bg-black position-fixed z-3 align-items-center justify-content-center">
...
.loader {
    ...
    background: linear-gradient(70deg, #eee, #303030 50%, #eee);
    background-size: 400%;
...
.spinner {
    ...
    animation-iteration-count: infinite;
    animation-timing-function: cubic-bezier(0.2,0.4,0.4,0);
}
